...
import com.lxh.mall.product.service.CategoryBrandRelationService;
...
//    CategoryDao categoryDao;
    ...
    //递归查找所有菜单子菜单
    private List<CategoryEntity> getChildrens(CategoryEntity rootEntity,List<CategoryEntity> all){
